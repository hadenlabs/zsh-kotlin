<!-- Space: Projects -->
<!-- Parent: ZshKolin -->
<!-- Title: Contributing GithubFlow ZshKolin -->
<!-- Label: ZshKolin -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-kotlin project on [GitHub](https://github.com/hadenlabs/zsh-kotlin), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-kotlin/pulls).
...
To follow the instructions in this guide and start contributing to zsh-kotlin project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-kotlin.git
```

Now your **upstream** points to **hadenlabs/zsh-kotlin**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-kotlin
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-kotlin/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
